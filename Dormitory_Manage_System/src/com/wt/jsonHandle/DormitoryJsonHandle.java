...
public class DormitoryJsonHandle extends ActionSupport implements 
ModelDriven<Dormitory>, Preparable{
	...
	// 注册创建用户
	public String add_newDormitory(){
		...
		System.out.println("4444dormitory_id --- " + dormitory_id + " dormitory_name --- " + dormitory_name + " dormitory_address --- " + dormitory_address + "dormitory_phone ---" + dormitory_phone);
		
		if(dormitory_id != null && dormitory_name != null && dormitory_address != null && dormitory_phone != null){
			System.out.println("dormitory_id --- " + dormitory_id + " dormitory_name --- " + dormitory_name + " dormitory_address --- " + dormitory_address + "dormitory_phone ---" + dormitory_phone);
